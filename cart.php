...
<body>
  ...
  <div>
    ...
    <table class="table table-bordered table-striped">
      ...
      <!--add in shop function / foreach loop-->
      ...
      <tr>
        ...
        <td>500</td>
        <td>1</td>
        <td>Quantity * Price = x</td>
        <td><a href="#"><button class="btn btn-danger btn-block">REMOVE</button></a></td>
      </tr>
      ...
      <tr>
        ...
        <td>500</td>
        <td><a href="#"><button class="btn btn-dark btn-block">CLEAR LIST</button></a>
  ...
  <p>Go Back to <a href="/products.php">Shop</a></p>
